job "dossier" {
  ...
  group "mysql" {
    ...
    # volume "silabs-ca-certificates" {
    #   type      = "host"
    #   read_only = true
    #   source    = "silabs-ca-certificates"
    # }
    ...
    #   }
      ...
      config {
        ...
        # volumes = [
        #   "name=dossier-mysql,io_priority=high,size=10,repl=2/:/var/lib/mysql",
        # ]
        # volume_driver = "pxd"
      }
...
-- Database: `cbs_wifi`
--
CREATE DATABASE IF NOT EXISTS `cbs_wifi` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cbs_wifi`;
...
EOF
    ...
    #   }
      ...
      config{
        image = "nocodb/nocodb"
        # volumes = [
        #   "name=dossier-nocoDB,io_priority=high,size=10,repl=2/:/usr/app/data/",
        # ]
        # volume_driver = "pxd"
      }
      ...
      service {
        ...
        tags = [
            "traefik.enable=true",
            "traefik.http.routers.nocodb-build-dashboard.entrypoints=https",
    ...
    #   }
      ...
      service {
        ...
        tags = [
            "traefik.enable=true",
            "traefik.http.routers.admin-build-dashboard.entrypoints=https",
